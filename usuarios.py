    ...
    if rol_actual.lower() in roles_jefes:
        ...
        with tab1:
            with st.form("nuevo_usuario", clear_on_submit=True):
                ...
                u_rol = st.selectbox("Rol y Permisos", ["admin", "Gerente", "Supervisor", "Diseño"])
                ...
                if "user_edit_id" in st.session_state:
                    with st.expander("📝 Editar Datos de Usuario", expanded=True):
                        with st.form("edit_form"):
                            ...
                            n_rol = st.selectbox("Rol", ["admin", "Gerente", "Supervisor", "Diseño"], 
                                               index=["admin", "Gerente", "Supervisor", "Diseño"].index(st.session_state.user_edit_data.get('rol', 'admin')))
